...
void renderFloor(int wallBottomPixel, color_t *texelColor, int x)
{
	...
	for (y = wallBottomPixel - 1; y < SCREEN_HEIGHT; y++)
	{
		...
		textureOffsetX = (int)(fabs(textureOffsetX * texture_width / 30)
								% texture_width);
		textureOffsetY = (int)(fabs(textureOffsetY * texture_height / 30)
								% texture_height);
...
void renderCeil(int wallTopPixel, color_t *texelColor, int x)
{
	...
	for (y = 0; y < wallTopPixel; y++)
	{
		...
		textureOffsetX = (int)(fabs(textureOffsetX * texture_width / 40)
								% texture_width);
		textureOffsetY = (int)(fabs(textureOffsetY * texture_height / 40)
								% texture_height);
